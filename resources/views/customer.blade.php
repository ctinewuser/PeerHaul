                                              ...
                                              @foreach($allCustomer as $users)   
                                               @php $i++; @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                    @if($users->status == 1) {{'Deactive'}} 
                                                    @elseif($users->status == 0 ) {{'Active'}}
                                                    @elseif($users->status == 3 ) {{'Blocked'}} 
                                                    ...
                                                    <a href="{{url('blockCustomer/'.$users->id)}}" class="btn btn-eye btn-info"  > <i class="fa fa-ban"> </i> </a>
                                                      
                                                      <a href="{{url('viewCustomer/'.$users->id)}}" class="btn btn-eye btn-info"  > <i class="fa fa-eye"> </i> </a>

                                                      <a href="{{url('removeCustomer/'.encrypt($users->id))}}" class="btn btn-link btn-danger" onclick="return confirm('Do you really want to delete customer');"> <i class="fa fa-times"> </i> </a>
